...
const CARD_DEFINITIONS = {
  ...
  mysticGuard: { id: "mysticGuard", name: "神秘の守り", type: "action", effectKey: "mysticGuard", text: "次の自分のターンまで、場のモンスターは相手のアクションや持ち物の効果を受けない。さらに自分のライフへのダメージを-1する。" },
  ...
  auroraVeil: { id: "auroraVeil", name: "オーロラベール", type: "action", effectKey: "damageMinusOneUntilNextTurn", text: "好きな山から1枚ドロー。次の自分のターンまで自分が受ける全てのダメージを-1する。" },
