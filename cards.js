...
const CARD_DEFINITIONS = {
  ...
  focusSash: { id: "focusSash", name: "気合いのタスキ", type: "item", effectKey: "surviveLethalAtOne", text: "満タンHPから致死ダメージを受けた時、HP1で耐える。発動後捨札。" },
  ...
  destinyCloak: { id: "destinyCloak", name: "道連れマント", type: "item", effectKey: "destroyOpponentOnDeath", text: "モンスターの攻撃や反撃で倒された時、攻撃した相手モンスターを捨札に送る。" },
  ...
  healingWater: { id: "healingWater", name: "癒し水", type: "action", effectKey: "healLifeThree", text: "自分のライフを+4。好きな山から1枚ドロー。" },
  preparation: { id: "preparation", name: "下準備", type: "action", effectKey: "searchTwoFromPile", text: "好きな山を見て好きな2枚を自分の手札に加え、手札から好きな1枚を捨てる。" },
  battleDrum: { id: "battleDrum", name: "バトルドラム", type: "action", effectKey: "drawOneBuffOwnField", text: "山札から1枚ドロー。自分の場のモンスターのパワーを+2する。" },
