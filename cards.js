...
const CARD_DEFINITIONS = {
  ...
  hippowdon: { id: "hippowdon", name: "カバルドン", type: "unit", hp: 4, power: 1, effectKey: "reduceNextOpponentAction", text: "攻撃の代わりに次ターンの相手のアクション権を-1できる。" },
  ...
  destinyCloak: { id: "destinyCloak", name: "道連れマント", type: "item", effectKey: "destroyOpponentOnDeath", text: "モンスターの攻撃を受け倒された時、攻撃した相手モンスターを捨札に送る。" },
  ...
  healingWater: { id: "healingWater", name: "癒し水", type: "action", effectKey: "healLifeThree", text: "自分のライフ+4。" },
  preparation: { id: "preparation", name: "下準備", type: "action", effectKey: "searchTwoFromPile", text: "好きな山を見て好きな3枚を自分の手札に加える。" },
