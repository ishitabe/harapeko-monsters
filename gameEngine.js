  ...
  function getPublicState(game, viewerId = game.activePlayer) {
    return {
      ...
      players: game.players.map((player, ownerId) => ({
        ...
        mysticGuardUntilTurn: player.mysticGuardUntilTurn,
        damageReductionUntilTurn: player.damageReductionUntilTurn,
        lifeDamageReductionUntilTurn: player.lifeDamageReductionUntilTurn,
